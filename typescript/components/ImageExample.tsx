...
export default {
    framework:   'React',
    title:       '<Image>',
    description: 'Base component for displaying different types of images.',
    examples:    [
                     {
                         ...
                         render:      function () {
                             return (
                                 <View style={styles.horizontal}>
                                     <Image source={require('../../images/uie_thumb_normal.png')} style={styles.icon}/>
                                     <Image source={require('../../images/uie_thumb_selected.png')} style={styles.icon}/>
                                     <Image source={require('../../images/uie_comment_normal.png')} style={styles.icon}/>
                                     <Image source={require('../../images/uie_comment_highlighted.png')} style={styles.icon}/>
                                 </View>
                             )
                         },
                     },
